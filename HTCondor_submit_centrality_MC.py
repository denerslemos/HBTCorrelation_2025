...
arguments = '''+inFiles+'''.txt '''+str(outFiles)+''' 1 0 0 10 5 2.0 0 0 0 '''+str(uncerSys)+'''
queue
'''
...
arguments = '''+inFiles+'''_part'''+str(i)+'''.txt '''+str(outFiles)+'''_job_'''+str(i)+''' 1 0 0 10 5 2.0 0 0 0 '''+str(uncerSys)+'''
queue
'''
		command_lines += temp
elif(ratio == 1):
